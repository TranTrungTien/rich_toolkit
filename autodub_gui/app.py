...
from autodub_gui.ui.debug_console import DebugConsole
...
class MainWindow(QMainWindow):
    ...
    def _install_shortcuts(self) -> None:
        ...
        # Shortcut for debug console
        from PySide6.QtGui import QKeySequence, QShortcut
        debug_shortcut = QShortcut(QKeySequence("Ctrl+Shift+D"), self)
        debug_shortcut.activated.connect(self._debug_console.show_toggle)
...
class _NavKeyFilter(QObject):
    ...
    _NAV_KEYS: typing.ClassVar[set[Qt.Key]] = {Qt.Key.Key_Left, Qt.Key.Key_Right, Qt.Key.Key_Up,
